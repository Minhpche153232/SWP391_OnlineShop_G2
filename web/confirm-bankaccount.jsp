<%-- 
    Document   : confirm-bankaccount
    Created on : Aug 24, 2024, 1:16:55 PM
    Author     : admin
--%>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <h5 class="text-success">${baTmp.bankCode}</h5>
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="cardNumber">Card number:</label>
                                <h5 class="text-success">${baTmp.cardNumber}</h5>
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="cardOwner">Card Owner:</label>
                                <h5 class="text-success">${baTmp.cardOwner}</h5>
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="expertDate">Expert date:</label>
                                <h5 class="text-danger">${baTmp.expertDate}</h5>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="formCfmCode" action="wallet" method="post">
                                ...
                                <input type="hidden" name="action" value="checkCodeLinkAccount">
